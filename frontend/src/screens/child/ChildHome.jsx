      ...
      <div className="p-4">
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-400 text-xs">{contract.subject_name} · {(GRADES[contract.grade] || contract.grade)}</p>
